...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--lambda_imu_gait", type=float, default=0.1, help="Weight for Stage-4 IMU gait-prediction auxiliary loss.")
    ...
    parser.add_argument("--lambda-gait", type=float, default=1.0, help="Weight for generated-vs-real gait-summary MSE loss in Stage 5.")
